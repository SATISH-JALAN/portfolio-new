...
export const Goals2026: React.FC<Goals2026Props> = ({ onBack }) => {
    ...
    useLayoutEffect(() => {
        ...
        const ctx = gsap.context(() => {
            ...
            // Removed goal-item animation - was causing visibility issues
        }, containerRef);
        return () => ctx.revert();
    }, []);
    ...
    return (
        <div ref={containerRef} className="min-h-screen bg-background pt-32 pb-24 px-4 md:px-6 relative z-50 overflow-y-auto">
            {/* Header */}
