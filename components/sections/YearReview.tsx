        ...
        <section id="experience" ref={containerRef} className="review-section py-32 bg-background relative overflow-hidden">
            <div className="container px-4 md:px-6 mx-auto">
                <div className="flex flex-col gap-24 lg:gap-32">
                        ...
                        <div className="relative ml-0 md:ml-4 pl-8 md:pl-12 space-y-16 pb-4 pt-2 lg:pt-0">
                            ...
                            {EXPERIENCE.map((exp) => (
                                <div key={exp.id} className="experience-item relative group">
                                    ...
                                    {exp.link ? (
                                        <a href={exp.link} target="_blank" rel="noopener noreferrer" className="block cursor-pointer px-4 py-2 -mx-4 rounded-xl hover:bg-[rgba(255,255,255,0.03)] transition-colors duration-300">
                                        ...
                                        <div className="cursor-default px-4 py-2 -mx-4 rounded-xl hover:bg-[rgba(255,255,255,0.03)] transition-colors duration-300">
                                            <div className="flex flex-col mb-4">
                                                <h4 className="text-2xl text-foreground/90 font-display font-medium group-hover:text-foreground transition-colors duration-300 mb-1">{exp.role}</h4>
                                                <div className="flex flex-wrap items-center gap-3 text-sm">
                                                    <span className="font-mono text-muted/80">{exp.company}</span>
                    ...
                    <div className="w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-[1fr_1.5fr] gap-12 lg:gap-24 items-start">
                        {/* Header Column */}
                        <div className="text-left lg:sticky lg:top-32">
                                ...
                                <div key={edu.id} className="education-item relative group">
                                    ...
                                    <div className="cursor-default px-4 py-2 -mx-4 rounded-xl hover:bg-[rgba(255,255,255,0.03)] transition-colors duration-300">
                                        <div className="flex flex-col mb-2">
                                            <h4 className="text-2xl text-foreground/90 font-display font-medium group-hover:text-foreground transition-colors duration-300 mb-1">{edu.degree}</h4>
                                            <div className="flex flex-wrap items-center gap-3 text-sm">
                                        ...
                                        {edu.location && (
                                            <p className="text-muted leading-relaxed max-w-2xl group-hover:text-foreground/80 transition-colors duration-300 text-sm">
                                                {edu.location}
                                            </p>
                                        )}
                                    </div>
